...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-white dark:from-brand-dark dark:via-gray-900 dark:to-brand-dark">
      ...
      {/* Profile Section */}
      <section className="py-16 relative z-10 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="overflow-hidden bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
              <div className="flex animate-scroll">
                {[...skills, ...skills].map((skill, index) => (
                  <span
                    key={index}
                    className="skill-tag bg-gradient-to-r from-brand-purple/10 to-purple-400/10 text-brand-purple dark:text-purple-300 px-4 py-2 rounded-full mx-2 whitespace-nowrap border border-brand-purple/20 font-medium"
                  >
                    {skill}
                  </span>
                ))}
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              <motion.div
                ...
                className="text-center p-6 lg:p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300"
              >
              ...
              <motion.div
                ...
                className="text-center p-6 lg:p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 sm:col-span-2 lg:col-span-1"
              >
                <div className="w-16 h-16 bg-brand-purple/10 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-2xl">🚀</span>
                </div>
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="bg-gradient-to-br from-brand-purple/5 via-purple-400/5 to-brand-purple/5 dark:from-brand-purple/10 dark:via-purple-400/10 dark:to-brand-purple/10 rounded-2xl p-8 lg:p-12 border border-gray-200 dark:border-gray-700">
